      ...
      <div class="container py-10">
        ...
        <div id="accordionContainer">
          <div v-for="(item, index) in faqList" :key="index" class="">
            ...
            >
              <button
                class="group relative flex w-full items-center rounded-t-lg border-0 px-5 py-4 text-2xl font-bold transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none [&:not([data-twe-collapse-collapsed])]:bg-white [&:not([data-twe-collapse-collapsed])]:text-primary-500 [&:not([data-twe-collapse-collapsed])]:shadow-border-b"
                type="button"
              ...
              >
                <img class="me-5" src="/img/title-faq-item.svg" width="20" />
                <span>{{ item.q }}</span>
                <span
        ...
        <div class="text-2xl">
          ...
          >
            ...
            <div class="grow px-3 text-center text-kv-green">
              歡樂互動｜來寶唱跳秀
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="grow px-3 text-center">永續宣言</div>
          </div>
          <div
            class="flex border-b border-primary-500 bg-white py-3 font-black"
          >
            <div class="max-w-[300px] grow px-3 text-center">11:00-11:30</div>
            <div class="grow px-3 text-center text-primary-500">企業時間</div>
          </div>
          <div
            class="flex border-b border-primary-500 bg-[#FFECE6] py-3 font-black"
          >
            <div class="max-w-[300px] grow px-3 text-center">11:30-11:50</div>
            <div class="grow px-3 text-center text-primary-500">
