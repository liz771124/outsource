<script setup>
  ...
  const faqList = [
    ...
    {
      q: '報名繳費後，因故不克參加可退費嗎？',
      a: '參與本活動並報名繳費成功者，即同意本活動規範所有規定。報名繳費後，因故不克參加者，請於3/29(六)前提出申請，主辦單位將扣除30%手續費後予以退費，3/30(日)起取消者恕無法退費，大會將於會後寄送福袋禮至報名者指定地點。'
    },
    {
      q: '活動因故延期如何因應？',
    ...
    {
      q: '下雨活動會取消嗎？',
      a: '如遇雨天將移至中山橋下進行未來親子園遊會，活動照常舉行不會取消喔！請務必留意活動前由大會發送之資訊。'
    },
    {
...
<template>
  <div>
    <Header>
      <img
        src="/img/kv-notice.svg"
        alt=""
        class="w-[450px] px-3 sm:w-[600px]"
      />
      <span
    ...
    <div class="bg-green">
      ...
      <div class="container py-16">
        ...
        <div class="flex flex-col items-center gap-3 text-3xl font-bold">
          <div class="mb-6">
            <img width="300" src="/img/title-alternative.svg" alt="" />
          </div>
        </div>
        <div id="notice-03" class="scroll-animate-fadeIn mb-8">
          <div class="mb-6">
            <img
              class="w-full rounded-xl"
              src="/img/alternative-img.jpg"
              alt=""
            />
          </div>
          <div class="mb-5">
            本活動如遇下雨天將移至中山橋下（原住民主題園區）舉辦。如何前往？
          </div>
          <div class="mb-3 text-[19px] font-bold text-primary-500">
            【搭乘大眾運輸工具】 <span></span>
          </div>
          <ul class="mb-5 flex flex-col gap-3">
            <li>
              從機場捷運A2三重站／捷運三重站出站後右轉往中山橋方向，沿大都會公園直行至「中山橋下-原住民主題園區」，步行約15分鐘。
            </li>
          </ul>
          <div class="mb-3">
            <span class="text-[19px] font-bold text-primary-500"
              >【自行騎車、開車】</span
            >
            <span>※車位有限，請盡量搭乘大眾運輸</span>
          </div>
          <ul class="flex flex-col gap-3">
            <li>
              1.
              直行捷運路至水漾路一段右轉→靠左上10號越堤道→左轉疏洪五路一段即會看到活動會場，會場斜對面有汽機車停車場。
            </li>
            <li>
              2. 直行疏洪西路上15號越堤道→下越堤道後直行疏洪十六路即會看到左側汽機車停車場，車輛停妥後步行至中山橋下活動會場約15分鐘。
            </li>
            <li>
              3.
              直行疏洪一路接疏洪十六路即會看到新北大都會公園右側汽機車停車場。
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container pb-20 pt-28">
        <div id="notice-02" class="scroll-animate-fadeIn mb-8">
          ...
          <ul class="flex flex-col gap-3">
            <li>
              1.
              本活動雨天照常進行，若活動前一週氣象預報顯示活動當日新北市三重區有70%下雨機率，即啟動雨備方案，活動改至新北市三重中山橋下（原住民主題園區）辦理，並以園遊會形式與親子家庭同歡。如遇海陸上颱風警報或不可抗拒之天然災害，為考量活動人身安全，大會有權宣布取消、延期或調整活動形式。
            </li>
            <li>
              2.
              本活動如因發生天災、重大事故、傳染病等因素造成大會取消或延期舉辦，會將相關訊息公布在活動官網上。
            </li>
            <li>
              3.本活動網頁僅為報名用途，非現場各項活動預約報名。各攤位現場活動體驗因適合年齡及容納人數皆不同，以現場排隊指示為主。
            </li>
            <li>
              4.主辦單位保有活動場地、時間、形式異動與解釋之權利，若有更改將另行通知。
            </li>
            <li>
              5.參加本活動即同意無償授權主辦單位使用活動期間所拍攝之照片與影片，並運用刊登於主辦單位所發行之包括但不限於平面刊物、網站、部落格、Facebook粉絲專頁及相關社群平台、電子報、EDM等相關之行銷活動規劃。
            </li>
            <li>
              6.參與對象以家庭(訂單)為單位，憑報到序號領取乙張闖關卡，若資料有重複者，將以時間序取第一次報名為主。
            </li>
            <li>
              7.所有贈品及獎項以實物為準，如遇產品缺貨或其他不可抗力之事由，主辦單位得保留更換等值獎品之權利，不另行告知。
            </li>
          </ul>
        </div>
        <div class="scroll-animate-fadeIn mb-8">
          ...
          <div>
            登記報名並於現場報到完成者，可獲得超值驚喜包一份，依網路報名並完成付款先後順序取符合資格者，於活動網頁上公告得獎名單。
          </div>
        </div>
        <div class="scroll-animate-fadeIn mb-8">
          ...
          <ul class="flex flex-col gap-3">
            ...
            <li>
              2.活動當天攜帶官方發送之報到序號簡訊報到完成，即可領取福袋禮(報到禮)。
            </li>
            <li>
              ※
        ...
        <div class="scroll-animate-fadeIn mb-8">
          ...
          <ul class="flex flex-col gap-3">
            <li>
              1.活動現場將提供：一個家庭(一筆訂單)一張闖關卡，合計1,500張供索取，發完為止。
            </li>
            <li>
        ...
        <div class="scroll-animate-fadeIn mb-8">
          ...
          <ul class="flex flex-col gap-3">
            ...
            <li>
              10.中獎者若為未滿18歲之未成年人，須檢附戶口名簿影本、法定代理人身分證正本及影本，並提出法定代理人所簽署之領獎同意書，方可辦理獎項領取。中獎者(或代為領獎之法定代理人)須自行負擔因兌獎所產生之稅金及後續衍生之所有費用(包含領牌、保險等相關程序費用)。
            </li>
