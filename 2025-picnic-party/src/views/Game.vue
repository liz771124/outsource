<script setup>
  ...
  const lotteryList = [
    ...
    },
    {
      ...
      price: '＄獎項價值 3,500 元 / 3 名'
    },
    {
      id: '15.jpg',
      brand: '福斯商旅',
      name: 'T6.1California露營車完整三天(72小時)體驗卷',
  ...
  const game01List = [
    ...
    },
    {
      id: '/game-01/08.jpg',
      brand: '福斯商旅',
      name: '愛家愛旅行！ 一起踏上VanLife神奇車旅吧！',
      description: `
        <p>"未來，你想要創造什麼樣的家族回憶？</p>
        <p>自由？勇敢？還是永續？「VanLife」，是一種隨興所至，說走就走的生活態度，以獨一無二的商旅車為家，車在哪，家就在哪。</p>
        <p>福斯商旅致力於VanLife精神的推廣，陪伴嚮往自由、同樂探索的家庭，露營車/七人座休旅車隨時隨地創造三代同堂的家族回憶！孩子們！快上車啟動我們的VanLife人生吧！</p>
      `
    }
    // {
    //   id: '/game-01/02.jpg',
