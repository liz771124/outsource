<script setup>
  ...
  const game01List = [
    ...
    },
    {
      ...
      description: `
        <p>福斯商旅擁有完整的七人座休旅車及露營車系，持續致力於 VanLife 樂旅人生的推廣，讓每個家庭都能找到最適合的七人座／露營車，也讓每位家人都能享受最好的款待。福斯商旅陪伴嚮往自由、出遊探索的每個你，一同踏上專屬於你的 VanLife 旅程！</p>
      `
    },
    {
      id: '/game-01/09.jpg',
    ...
    },
    {
      ...
      name: '醫材探險隊，出動！',
      description:
        '醫療器材在我們日常生活中隨處可見，但如何選購與正確使用呢?食品藥物管理署透過好玩的闖關遊戲，及趣味故事，讓大、小朋友們在活動中邊玩邊學，一起認識選用醫材有撇步，看清查證安心用。'
    }
    // {
    //   id: '/game-01/02.jpg',
    //   name: '',
