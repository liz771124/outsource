<script setup>
  ...
  const showItems = [
    ...
    },
    {
      ...
      description:
        '平均年齡只有12歲的「J HALL樂團」成軍邁入5年，是華語樂壇史上最年輕的兒童樂團，將帶來孩子也能搖滾的演唱會，為現場爸爸媽媽與小朋友帶來多首朗朗上口的歌曲，一起來搖滾慶生Party吧！'
    },
    {
      id: '/show/03.jpg',
      title: '楊元慶',
    ...
    },
    {
      ...
      description: `
        ...
        <p> ★表演場次★ 13:00、13:30、14:00、14:30（依現場流程為主）</p>
      `
    },
    {
      id: '/show/09.jpg',
      ...
      subtitle: '來寶歡樂大遊行',
      description: `
        <p>最萌的來寶小壽星和他的好朋友來跟大家拍照囉！Ｑ度和顏值都爆表的見面會，絕對不能錯過！</p>
        <p>★遊行場次★ 12:00、13:40、15:00（依現場流程為主）</p>
      `
    }
